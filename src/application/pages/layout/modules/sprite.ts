export class Sprite {
  constructor() {
    ...
    sprite.innerHTML = `
    <svg>
      <symbol viewBox="0 0 100 100" id = 'github'>
      ...
      <symbol fill="none" viewBox="0 0 50 50" id = 'user'>
        <path opacity="0.8" d="M37.7904 45.0413C35.9571 45.5829 33.7904 45.8329 31.2487 45.8329H18.7487C16.207 45.8329 14.0404 45.5829 12.207 45.0413C12.6654 39.6246 18.2279 35.3535 24.9987 35.3535C31.7696 35.3535 37.3321 39.6246 37.7904 45.0413Z" stroke="#BCBEC1" stroke-width="3.125" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M45.8333 18.75V31.25C45.8333 39.125 43.4583 43.4375 37.7917 45.0417C35.9583 45.5834 33.7917 45.8334 31.25 45.8334H18.75C16.2083 45.8334 14.0417 45.5834 12.2083 45.0417C6.54166 43.4375 4.16666 39.125 4.16666 31.25V18.75C4.16666 8.33335 8.33333 4.16669 18.75 4.16669H31.25C41.6667 4.16669 45.8333 8.33335 45.8333 18.75Z" stroke="#BCBEC1" stroke-width="3.125" stroke-linecap="round" stroke-linejoin="round"/>
        <path opacity="0.8" d="M32.4581 22.0416C32.4581 26.1666 29.1248 29.5208 24.9998 29.5208C20.8748 29.5208 17.5415 26.1666 17.5415 22.0416C17.5415 17.9167 20.8748 14.5833 24.9998 14.5833C29.1248 14.5833 32.4581 17.9167 32.4581 22.0416Z" stroke="#BCBEC1" stroke-width="3.125" stroke-linecap="round" stroke-linejoin="round"/>
      </symbol>
      <symbol viewBox="0 0 30 30" id = 'logo'>
        <path fill-rule="evenodd" clip-rule="evenodd" d="M30 0H0V30H30V0ZM15.0508 22.3144C15.0508 24.8378 13.5484 26.3072 10.9584 26.3072C8.48486 26.3072 6.98242 24.8378 6.91602 22.5884V22.522H9.34814V22.5718C9.39794 23.4932 9.9458 24.1406 10.9252 24.1406C11.9878 24.1406 12.544 23.5014 12.544 22.2978V14.022H15.0508V22.3144ZM26.5786 22.4306C26.5786 24.8046 24.7358 26.3072 21.7476 26.3072C18.8838 26.3072 17.0742 24.9376 16.9332 22.8124L16.9248 22.6796H19.3404L19.3486 22.7626C19.44 23.6592 20.4112 24.2652 21.814 24.2652L24.0718 22.7046C24.0718 21.7832 24.0718 22.6962 24.0718 22.6962C24.0718 21.9078 23.4824 21.4678 21.9966 21.1606L20.7348 20.9034C18.2446 20.397 17.1738 19.2348 17.1738 17.417V17.4086C17.1738 15.184 19.083 13.7148 21.7392 13.7148C24.5366 13.7148 26.1802 15.1924 26.3378 17.1928L26.3462 17.3008H23.9888L23.9722 17.2012C23.831 16.3462 23.001 15.7486 21.7392 15.7486C20.5024 15.7568 19.6806 16.3212 19.6806 17.2178V17.226C19.6806 18.0064 20.2618 18.4712 21.6728 18.7618L22.9428 19.019C25.4746 19.542 26.5786 20.5546 26.5786 22.4224V22.4306Z" fill="#BCBEC1"/>
      </symbol>
      <symbol viewBox="0 0 552.8 205.3" id = 'rs-school'>
        ...
        <g class="st1">
          ...
          <clipPath id="SVGID_10_"><use xlink:href="#SVGID_9_" overflow="visible"/>
          </clipPath>
          <g class="st8">
            <ellipse transform="rotate(-37.001 420.46 67.88)" class="st5" cx="420.5" cy="67.9" rx="63" ry="51.8"/>
          </g>
